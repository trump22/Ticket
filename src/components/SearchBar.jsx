    ...
    return (
        <div className="w-full px-4 flex justify-center">
            <div ref={wrapperRef} className="relative w-full max-w-[376px]">
                {/* Search Box */}
                <div className="h-[47px] bg-white rounded-[13px] overflow-hidden w-full shadow-md">
                    <div className="flex items-center w-full h-full px-2">
                        ...
                        <button
                            className="text-black text-sm md:text-base font-['Inter'] mr-1 md:mr-3 whitespace-nowrap"
                        >
                            Tìm kiếm
                        </button>
                    </div>
                ...
                {isFocused && filteredResults.length > 0 && (
                    <ul className="absolute z-10 mt-2 w-full bg-white border border-gray-200 rounded-[10px] shadow-lg max-h-60 overflow-auto">
